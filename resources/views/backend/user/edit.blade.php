...
<div class="card mt-4">
    <form class="needs-validation" id="userForm" action="{{route('admin.users.update',['user' => $user->id])}}" method="post" enctype="multipart/form-data" autocomplete="off">
        @csrf
        @method('PUT')
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="select2-width-50" name="user_type" id="user_type">
                            ...
                            <option value="2" @if($user->type == 2){{'selected'}}@endif>{{'Customer'}}</option>
