...
@section('content')
	<div class="content-body">
        ...
        <div class="card mt-4">
            <form class="needs-validation" id="domain" action="{{route('admin.domains.store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="success_message" name="success_message" rows="5" cols="50" placeholder="Enter success message"
                                    class="form-control @error('success_message') is-invalid @enderror"></textarea>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="error_message" name="error_message" rows="5" cols="50" placeholder="Enter error message"
                                    class="form-control @error('error_message') is-invalid @enderror"></textarea>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label">Email Template</label>
                                    <textarea cols="80" id="template" name="template" rows="10" class="form-control ckeditor @error('template') is-invalid @enderror" placeholder="Enter template"></textarea>
                                @error('template')
