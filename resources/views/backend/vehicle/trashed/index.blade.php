...
@section('content')
                                                        ...
                                                        <td>
                                                            <div class="dropdown ms-auto text-right" style="cursor: pointer;">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{route('admin.vehicle.trashed.restore',$value->id)}}" title="restore"><i class="fas fa-sync-alt" style="color: #3A82EF;"></i> Restore</a>
                                                                    <a class="dropdown-item" data-bs-target="#deleteConfirm" href="javascript:void(0);" 
                                                                        data-bs-toggle="modal" title="Delete" 
                                                                        onclick="deleteConfirm('{{ route('admin.vehicle.trashed.destroy',$value->id)}}','Are you sure you, want to delete permanently?')"><i class="fa fa-trash" style="color: red;"></i> Delete</a>
    ...
    <input type="hidden" class="actionUrl" value="{{route('admin.vehicle.trashed.action')}}">
@endsection
@section('scripts')
    @parent
